      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardBody className="space-y-3">
            ...
            <InfoRow label="Jumlah Dibayar">
              <span className="text-green-600">
                {formatCurrency(totalPaid.toString())}
              </span>
            </InfoRow>
            <InfoRow label="Sisa Pembayaran">
              <span
    ...
    <div className="space-y-6">
      ...
      {showClient && (
        <Card>
          ...
          <CardBody className="space-y-3">
            <InfoRow label="Nama Klien">{event.clientName}</InfoRow>
            <InfoRow label="No. Telepon" icon={<IconPhone size={14} />}>
              {event.clientPhone}
            </InfoRow>
            <InfoRow
            ...
            >
              {event.clientPhoneSecondary || "—"}
            </InfoRow>
            <InfoRow label="Email" icon={<IconMail size={14} />}>
              {event.clientEmail || "—"}
            </InfoRow>
          </CardBody>
        </Card>
