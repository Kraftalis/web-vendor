  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div>
           <h3 className="text-sm font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-4">Informasi Dasar</h3>
        </div>
        <Input
          name="name"
          label="Nama Paket"
      ...
      <div className="space-y-4">
         <div>
           <h3 className="text-sm font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-4">Variasi & Harga</h3>
        </div>
      ...
      <div className="space-y-4">
        <div>
           <h3 className="text-sm font-semibold text-gray-900 border-b border-gray-100 pb-2 mb-4">Pengaturan</h3>
        </div>
        ...
        <div className="flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50/50 p-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-gray-500">
              Menentukan apakah paket ini dapat dilihat oleh klien di halaman booking.
            </p>
          </div>
        </div>
      </div>
